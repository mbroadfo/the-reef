...
export default function Sidebar() {
  ...
  return (
    <div className="flex flex-col bg-reef-card border-r border-reef-border overflow-hidden h-full">
      {/* Logo */}
      <div className="flex items-center border-b border-reef-border shrink-0" style={{ height: '88px', padding: '6px 8px', gap: '8px', paddingLeft: '18px' }}>
        <img src={reefLogo} alt="The Reef" style={{ height: '72px', width: 'auto', filter: 'brightness(1.4) drop-shadow(0 0 6px rgba(0,255,136,0.3))', flexShrink: 0 }} />
